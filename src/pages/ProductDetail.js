          ...
          <div>
            ...
            <div className="mb-4">
              {product.images && product.images.length > 0 ? (
                <img
                  src={
                    isCloudinaryImage(product.images[selectedImage])
                      ? getResponsiveImageUrl(
                      ...
                      ? `${process.env.REACT_APP_API}${product.images[selectedImage]}`
                      : `${process.env.REACT_APP_API}/uploads/${product.images[selectedImage]}`
                  }
                  alt={product.title}
                    ...
                    <img
                      src={
                        isCloudinaryImage(image)
                          ? getThumbnailUrl(image, 80)
                          : image.startsWith("http")
                          ? image
                          : image.startsWith("/uploads/")
                          ? `${process.env.REACT_APP_API}${image}`
                          : `${process.env.REACT_APP_API}/uploads/${image}`
                      }
